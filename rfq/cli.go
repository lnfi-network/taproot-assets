...
type CliConfig struct {
	...
	AcceptPriceDeviationPpm uint64 `long:"acceptpricedeviationppm" description:"the price deviation in parts per million that is accepted by the RFQ negotiator. Example :5% (50,000 ppm)."`
...
func (c *CliConfig) Validate() error {
	...
	// Ensure that if the price oracle address not the mock price oracle
	// service address then it must be a valid gRPC address.
	if c.AcceptPriceDeviationPpm != "" &&
		c.AcceptPriceDeviationPpm != MockPriceOracleServiceAddress {
